...
/**** Menu mobile ****/
const btnMobile = document.querySelector(".button-open-menu")
const btnCloseMobile = document.querySelector(".close-menu-mobile ")
const body = document.querySelector("body")

btnMobile.addEventListener("click", () => {
  body.classList.add("showMobile")
})

btnCloseMobile.addEventListener("click", () => {
  body.classList.remove("showMobile")
})

/*** links menu fechando mobile */
function close() {
  body.classList.remove("showMobile")
}
